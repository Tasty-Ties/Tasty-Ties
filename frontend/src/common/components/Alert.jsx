    ...
    >
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
          <Dialog.Panel className="max-w-lg relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="bg-gray-50 px-4 py-3 flex flex-row-reverse sm:flex sm:flex-row-reverse sm:px-6">
              <button
                type="button"
                className="inline-flex rounded-md border border-transparent shadow-sm px-3 py-1 bg-second-400 text-base font-medium text-white hover:bg-second-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-second-600 sm:ml-3 sm:w-auto sm:text-sm"
                onClick={() => setOpen(false)}
              >
                확인
              </button>
