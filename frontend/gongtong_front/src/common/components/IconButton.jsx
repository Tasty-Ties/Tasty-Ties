const IconButton = ({ text, icon, type, onClick, value }) => {
  const typeList = {
    "mypage-border": "",
    "class-color": "",
    "class-border": "",
    ...
    "green-short":
      "bg-first hover:bg-first-800 text-white font-bold py-2 px-4 rounded items-center flex flex-row",
  };
