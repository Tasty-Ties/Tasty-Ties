...
const CookingClassList = () => {
  return (
    <div className="h-screen flex flex-col w-3/4 mx-auto content-center relative">
      <Typography variant="h4" className="ml-12 mt-8">
        최신 등록된 강의
      </Typography>
      <Carousel
        className="h-96 px-6 flex items-center overflow-hidden"
