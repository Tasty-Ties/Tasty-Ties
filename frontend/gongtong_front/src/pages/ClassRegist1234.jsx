...
const ClassRegist = () => {
  ...
  const [classInformation, setClassInformation] = useState(() => {
    ...
    return {
      ...
      languageName: "",
      level: 0,
      cookingClassStartTime: startTime,
      cookingClassEndTime: endTime,
      dishCookingTime: 0,
      ingredients: [],
      recipe: [],
      cookingTools: [],
        ...
        <div className="grid grid-cols-8">
          ...
          <div className="col-span-6">
            <input
              ...
              type="datetime-local"
              value={classInformation.cookingClassStartTime}
              min={classInformation.cookingClassStartTime}
            ...
            <input
              ...
              className="w-1/2 px-4 py-2 mb-4 border rounded-lg shadow-sm bg-white text-gray-700 border-gray-300 focus:outline-none focus:ring-2 focus:ring-first focus:border-first"
              value={classInformation.cookingClassEndTime}
              min={classInformation.cookingClassStartTime}
              onChange={(e) => {
                setClassInformation({
                  ...classInformation,
