...
public class CookingClassExceptionHandler {
    ...
    @ExceptionHandler(CookingClassNotFoundException.class)
    public ResponseEntity<CommonResponseDto> handleClassNotFoundException(CookingClassNotFoundException ex) {
